...
# hardware. The initial release contains platform_profile support plus Linux
# 6.18/7.1 API compatibility.
source=(
  'uniwill-acpi.c'
  'uniwill-wmi.c'
  'uniwill-wmi.h'
...
sha256sums=(
  '862dd4f046a97101c2fa795b55cac6baa28065f959a32a808076caa2e189991a'
